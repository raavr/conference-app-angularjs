...
export default function NewsConfig($stateProvider) {
    $stateProvider
        .state({ name: "newsList", url: "/news", component: "newsList", resolve: { news: NewsListResolve }})
        .state({ name: "news", url: "/news/{newsId}", component: "newsDetail", resolve: { news: NewsDetailResolve }});
}
